...
const styles = StyleSheet.create({
  ...
  eventName: { fontFamily: theme.fonts.heading, fontSize: 20, color: '#FFFFFF', marginBottom: 8 },
  eventDate: { fontSize: 16, color: theme.colors.gold, marginBottom: 4 },
  eventVenue: { fontSize: 16, color: theme.colors.lightGrey, marginBottom: 15 },
  ...
  featureCard: { width: '48%', backgroundColor: theme.colors.navyBlue, padding: 22, borderRadius: 20, marginBottom: 18, alignItems: 'center' },
  featureTitle: { fontFamily: theme.fonts.heading, fontSize: 18, color: theme.colors.gold, marginTop: 12, marginBottom: 8 },
  featureDesc: { fontSize: 15, color: '#FFFFFF', textAlign: 'center' },
